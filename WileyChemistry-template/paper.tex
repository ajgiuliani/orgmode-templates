...
For citations, please provide your library used as \texttt{Bib}\TeX file (.bib) and use the Wiley-chemistry.bst citation style (please also check the example references at the end of this file and further information on CCDC deposition numbers in the \hyperref[sec:org16fcaa4]{Experimental}.\cite{article1,article2,book,article3,WEB,bookvolume}
\section*{Results and Discussion}
\label{sec:org685e3d0}
...
[[label_name]]
\end{verbatim}
for the reference. The name of the section or subsection will then appear in you PDF document as clickable linke, as shown in the following examples: \hyperref[sec:org16fcaa4]{Expeirmental} and \hyperref[sec:org23b655c]{Experimental for Angewandte Chemie}
...
\end{table*}
\section*{Conclusion}
\label{sec:orgda03221}
Conclusion text.
\section*{Experimental}
\label{sec:org16fcaa4}
