...
#+LATEX_HEADER: \usepackage[backend=biber,citestyle=numeric-comp,bibstyle=chem-acs,sorting=none]{biblatex}
#+latex_header: \addbibresource{references.bib}

#+latex_header: \renewcommand*{\mkbibbrackets}[1]{#1}
#+latex_header: \renewcommand*{\mkbibsuperscript}[1]{\textsuperscript{#1}}

#+latex_header: \DeclareFieldFormat{labelnumber}{\textsuperscript{#1}}
#+latex_header: \DeclareFieldFormat{labelnumberwidth}{\textsuperscript{#1}}
...
#+latex: \title{A ``template'' model document for submission to the American Chemical Society (ACS)}
...
\textsf{natbib} package will be loaded and you can use it's commands.\cite{article1,article2,book,article3,WEB,bookvolume}.
...
\textbackslash ce{H2SO4} gives \ce{H2SO4}. The two have similar
