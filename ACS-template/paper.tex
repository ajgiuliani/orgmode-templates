...
\usepackage{capt-of}
\usepackage{hyperref}
\usepackage[backend=biber,citestyle=numeric-comp,bibstyle=chem-acs,sorting=none]{biblatex}
...
\title{A ``template'' model document for submission to the American Chemical Society (ACS)}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=8.6cm]{sch.pdf}
...
Entry three\textsuperscript{\textbf{{[}b]}}\textsuperscript{nil} & Entry four\\
\hline
